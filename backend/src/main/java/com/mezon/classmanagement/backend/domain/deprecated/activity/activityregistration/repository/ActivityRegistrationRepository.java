package com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.repository;
...
public interface ActivityRegistrationRepository extends JpaRepository<ActivityRegistration, Long> {
	...
	@Query(value = """
	select new com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.dto.response.ActivityRegistrationResponseDto(
