...
public class ClassUserRequestController {
	...
	public ResponseDTO<ClassUserRequestIdResponseDto> reject(
		...
		ClassUserRequestIdResponseDto response = classUserRequestService.reject(classId, requestId);
	...
	public ResponseDTO<List<ClassUserRequestResponseDto>> getByClass(
		...
		List<ClassUserRequestResponseDto> response = classUserRequestService.getByClass(classId);

		return ResponseDTO.<List<ClassUserRequestResponseDto>>builder()
				.success(true)
				.message("Get join class request by class successful")
				.data(response)
				.build();
	}
	...
	public ResponseDTO<List<ClassUserRequestResponseDto>> getByUser() {
		...
		List<ClassUserRequestResponseDto> response = classUserRequestService.getByUser(userId);

		return ResponseDTO.<List<ClassUserRequestResponseDto>>builder()
				.success(true)
				.message("Get join class request by user successful")
				.data(response)
				.build();
	}
