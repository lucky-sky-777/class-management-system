package com.mezon.classmanagement.backend.domain.deprecated.activity.service;
...
import com.mezon.classmanagement.backend.domain.deprecated.activity.dto.response.ActivityIdResponseDto;
import com.mezon.classmanagement.backend.domain.deprecated.activity.dto.response.ActivityResponseDto;
import com.mezon.classmanagement.backend.domain.deprecated.activity.dto.response.ActivitySummaryResponseDto;
import com.mezon.classmanagement.backend.domain.deprecated.activity.entity.Activity;
import com.mezon.classmanagement.backend.domain.deprecated.activity.mapper.ActivityMapper;
import com.mezon.classmanagement.backend.domain.deprecated.activity.repository.ActivityRepository;
