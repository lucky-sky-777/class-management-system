package com.mezon.classmanagement.backend.domain.deprecated.fund.paymentaccount.service;

import com.mezon.classmanagement.backend.domain_public.bank.util.BankQrCodeUrlGenerator;
import com.mezon.classmanagement.backend.domain.auth.entity.User;
import com.mezon.classmanagement.backend.domain.clazz.entity.Class;
import com.mezon.classmanagement.backend.domain.deprecated.fund.paymentaccount.dto.CreateOrUpdatePaymentAccountRequestDto;
import com.mezon.classmanagement.backend.domain.deprecated.fund.paymentaccount.dto.PaymentAccountResponseDto;
import com.mezon.classmanagement.backend.domain.deprecated.fund.paymentaccount.entity.PaymentAccount;
import com.mezon.classmanagement.backend.domain.deprecated.fund.paymentaccount.mapper.PaymentAccountMapper;
import com.mezon.classmanagement.backend.domain.deprecated.fund.paymentaccount.repository.PaymentAccountRepository;
