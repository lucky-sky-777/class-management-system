package com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.service;

import com.mezon.classmanagement.backend.common.exeption.entity.GlobalException;
import com.mezon.classmanagement.backend.common.security.annotation.RequireClassSecurity;
import com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.dto.request.UpdateActivityRegistrationRequestDto;
import com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.dto.response.ActivityRegistrationIdResponseDto;
import com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.dto.response.ActivityRegistrationResponseDto;
import com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.entity.ActivityRegistration;
import com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.mapper.ActivityRegistrationMapper;
import com.mezon.classmanagement.backend.domain.deprecated.activity.activityregistration.repository.ActivityRegistrationRepository;
