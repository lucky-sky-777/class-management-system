package com.mezon.classmanagement.backend.domain.deprecated.absencerequest.repository;
...
public interface AbsenceRequestRepository extends JpaRepository<AbsenceRequest, Long> {
    ...
    @Query(value = """
    select new com.mezon.classmanagement.backend.domain.deprecated.absencerequest.dto.response.AbsenceRequestResponseDto(
        absenceRequest.id,
        class.id,
