package com.mezon.classmanagement.backend.domain.deprecated.fund.fundpayment.repository;
...
public interface FundPaymentRepository extends JpaRepository<FundPayment, Long> {
	...
	@Query(value = """
	select new com.mezon.classmanagement.backend.domain.deprecated.fund.fundpayment.dto.FundPaymentResponseDto(
		fundPayment.id,
		class.id,
		fund.id,
