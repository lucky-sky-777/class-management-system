package com.mezon.classmanagement.backend.domain.deprecated.point.repository;
...
public interface PointRepository extends JpaRepository<Point, Long> {
	...
	@Query(value = """
	select new com.mezon.classmanagement.backend.domain.deprecated.point.dto.PointResponseDto (
		point.id,
		class.id,
		group.id,
		point.description,
	...
	@Query(value = """
	select new com.mezon.classmanagement.backend.domain.deprecated.point.dto.WeekPointRankingResponseDto(
		null,
		group.name,
	...
	@Query(value = """
	select new com.mezon.classmanagement.backend.domain.deprecated.point.dto.MonthPointRankingResponseDto(
		null,
