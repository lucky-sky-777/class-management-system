...
import {GraduationCap, Map as MapIcon, Maximize, Presentation, Shuffle, ZoomIn, ZoomOut,} from "lucide-react";
        ...
        >
            ...
            >
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 w-full">
                    <div
                        className="flex bg-[var(--bg-surface-2)] p-1 rounded-lg w-full sm:w-auto border border-[var(--rule)]">
                ...
                <span className="hidden xs:inline">
                  ...
                  {m === "view"
                    ...
                    <div
                        className="flex items-center gap-2 overflow-x-auto w-full sm:w-auto pb-1 sm:pb-0 no-scrollbar justify-start sm:justify-end">
            ...
            <div className="flex flex-col-reverse md:flex-row justify-between items-end gap-4 w-full relative z-10">
                <div className="w-full md:w-2/3" onClick={(e) => e.stopPropagation()}>
                    {mode === "setup" && (
                        <div
                            className="bg-[var(--warm-fill)] p-3 rounded-xl border border-[var(--warm-border)] animate-in fade-in zoom-in-95 duration-300 flex flex-col gap-3">
                  ...
                  <span className="text-[10px] md:text-xs font-bold text-[var(--warm-600)] uppercase tracking-wider">
                    Danh sách xếp chỗ
                                    ...
                                    <span
                                        className="text-[9px] md:text-[10px] text-[var(--ink-3)] font-medium ml-1.5 normal-case tracking-normal inline-block">
                ...
                >
                    {({zoomIn, zoomOut, resetTransform}) => (
                        <div className="w-full h-full relative">
                            {/* THANH CÔNG CỤ ZOOM */}
                            <div
                                className="absolute top-4 left-4 z-50 flex flex-col gap-2 bg-[var(--bg-surface)]/90 backdrop-blur-md p-1.5 rounded-2xl shadow-md border border-[var(--rule-md)]">
                                <button
                                    onClick={() => zoomIn()}
                            ...
                            {showMinimap && minimapImg && (
                                <div
                                    className="absolute bottom-6 right-6 z-50 w-48 bg-white border-2 border-[var(--rule-md)] rounded-lg shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 pointer-events-none select-none">
                                    <img src={minimapImg} alt="Sơ đồ lớp thu nhỏ"
                                         className="w-full h-auto opacity-60 bg-[var(--bg-paper)]"/>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className="bg-[var(--bg-surface)] px-12 py-4 rounded-xl border-2 border-[var(--warm-border)] flex items-center justify-center relative shrink-0 min-w-[160px]">
                        ...
                        <span className="text-xs font-black text-[var(--ink-3)] uppercase tracking-[0.4em]">
                          Bảng Đen
                                                ...
                                                <div
                                                    className="w-96 h-5 bg-[#1a1c23] rounded-md shadow-lg border-b-[4px] border-[#4a3f35]"/>
                                            </div>
                                        </div>
